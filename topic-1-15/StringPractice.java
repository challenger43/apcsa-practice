...
public class StringPractice {
    ...
    public static String oneSpace(String input){
        ...
        return (space1 != -1 && space1 == input.lastIndexOf(' '));
    }
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        String startPhrase = "The evolution stages of the";
        // String phrase1 = "Wooper Quagsire";
        // String phrase2 = "Psyduck Golduck";
        System.out.println("Enter a phrase of two words, separated by a space. Do not include other spaces");
        while (!input.hasNextLine()){
            System.out.println("make sure to type something.");
            input.nextLine();
        }
        String tempValue = input.hasNextLine; 
        while (!input.hasNextLine()|| !tempValue.Contains(" ") || !oneSpace(tempValue.NextLine())){
            System.out.println("Follow directions.");
            input.nextLine();
        }

        String phrase = practice(input.nextLine());
